...
#  File Objective : Identifica o tipo de url
#  File Name : processuriget.py
#  File Date : 24/09/2020 03:11
#  File Change : 24/09/2020 03:11
...
class ProcessUriGet:
    ...
    def spark(v_response, v_uri):
        ...
        if v_path == v_domain:
            ...
            # Function ->
            return ThreatDetect.m_get(v_response, v_uri)
